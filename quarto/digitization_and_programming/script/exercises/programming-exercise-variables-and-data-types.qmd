...
1.  Schreibe ein kleines Python-Programm, das eine Variable für die Fläche eines Kreises berechnet und speichert. Nutze für den Wert von $\pi$ die Konstante aus dem `math` Modul.
