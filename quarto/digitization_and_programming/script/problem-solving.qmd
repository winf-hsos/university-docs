...
![](https://winf-hsos.github.io/university-docs/images/problem_solving_input_computation_output_lifi.png){fig-align="center" width=60%}
...
![](https://winf-hsos.github.io/university-docs/images/problem_solving_input_computation_output_lifi_devices.png){fig-align="center" width=60%}

Vielleicht ist dir aufgefallen, dass die Struktur des gesamten Buches an den gerade identifizierten, übergeordneten Problemstellungen ausgerichtet ist. Wir befinden uns gerade im [ersten Teil](part-problems.qmd) und sprechen darüber, wie wir Probleme im Computer darstellen. Im [zweiten Teil des Buches](part-representation.qmd) lernen wir, wie Computer ganz unterschiedliche Informationen repräsentieren können, damit sie für die Lösung des Problems verwendet werden können. Im dritten Teil beschäftigen wir uns damit, wie Computer Informationen verarbeiten. Der vierte und letzte Teil führt uns in wichtige Konzepte der Kommunikation mithilfe von Computern und Netzwerken ein.
...
![Das Wörterzählen-Problem im EVA-Modell](https://winf-hsos.github.io/university-docs/images/problem_solving_example_word_count.png){fig-align="center" width=60%}
...
![Verteiltes Wörterzählen](https://winf-hsos.github.io/university-docs/images/problem_solving_example_word_count_distribute_further.png){fig-align="center" width=60% #fig-problem-solving-word-count-distributed}
...
![Das parallelisierte Wörterzählen im EVA-Modell ](https://winf-hsos.github.io/university-docs/images/problem_solving_example_word_count_distribute_parallelize.png){fig-align="center" width=60% #fig-eva-distributed}
