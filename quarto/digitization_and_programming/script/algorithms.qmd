...
Diese Strategie, die wir bereits im vorigen Kapitel unter @sec-divide-and-conquer als *Divide-and- Conquer*-Ansatz\index{Divide-and-Conquer-Ansatz} kennengelernt haben, ermöglicht es der binären Suche, selbst in großen Datensätzen ein gesuchtes Element mit minimaler Anzahl von Vergleichsoperationen zu finden.
