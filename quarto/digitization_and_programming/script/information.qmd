---
title: "Informationen {#sec-information}"
...
![Lauet dieser Definition erhöht Information unsere Treffsicherheit bei Vorhersagen.](https://winf-hsos.github.io/university-docs/images/information_definition_adami.png){fig-align="center" width=60% .lightbox}
...
![Ich denke an eine Zahl zwischen 1 und 16. Deine Aufgabe ist es, die Zahl mit so wenig Fragen wie möglich zu erraten.](https://winf-hsos.github.io/university-docs/images/number_guessing_game_1.png){fig-align="center" width=60% .lightbox}
...
![Deine Fragen sollten die Anzahl der Möglichkeiten halbieren.](https://winf-hsos.github.io/university-docs/images/number_guessing_game_2.png){fig-align="center" width=60% .lightbox}
...
![Nach zwei Fragen bleiben noch 4 Möglichkeitn, wenn die Fragen gut gewählt wurden.](https://winf-hsos.github.io/university-docs/images/number_guessing_game_3.png){fig-align="center" width=60% .lightbox}
...
![Wir benötigen vier Ja/Nein-Fragen, um die Optionen von 16 auf eine einzige zu reduzieren.](https://winf-hsos.github.io/university-docs/images/number_guessing_game_6.png){fig-align="center" width=60% .lightbox}
