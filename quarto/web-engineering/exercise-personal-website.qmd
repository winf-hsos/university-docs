...
Für die persönliche Webseite wollen wir ein eigenes Webseiten-Projekt anlegen. Initialisiert ein neues Projekt und erstellt eine Datei `index.html` mit dem HTML-Basisgerüst:
